...
import com.rkostiuk.uconsole.command.impl.*;
...
public class CommandFactoryConfig {
    ...
    public CommandFactory commandFactory(DepartmentService departmentService) {
        Map<CommandType, Command> commandMap = Map.of(
                ...
                DEPARTMENT_STATISTICS, new DepartmentStatisticsCommand(departmentService),
                GLOBAL_SEARCH, new GlobalSearchCommand(departmentService)
        );
